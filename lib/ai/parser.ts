...
export async function parseRecord(
  ...
  return {
    ...
    meal: (validated.meal ?? null) as import('@/types/record').MealScore | null,
    health: (validated.health ?? null) as import('@/types/record').HealthScore | null,
    excretion: (validated.excretion ?? null) as import('@/types/record').ExcretionScore | null,
    hydration: (validated.hydration ?? null) as import('@/types/record').HydrationScore | null,
